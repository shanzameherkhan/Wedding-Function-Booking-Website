...
<head>
  <meta charset="utf-8">
  <title>Catering - AA Wedding House</title>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">Food,Like you Never Had,Hire Us.</span><strong class="text-slider"></strong></p>
