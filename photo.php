...
<head>
  <meta charset="utf-8">
  <title>Photo - AA Wedding House</title>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">Photography, Make Memories to Last you a Life, Hire Us. </span><strong class="text-slider"></strong></p>
