...
<head>
  <meta charset="utf-8">
  <title>Themes - AA Wedding House</title>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">Themes,To Have You Come Again,Hire Us.</span><strong class="text-slider"></strong></p>
...
<div id="#das">
 <h2 class="text-center">Theme Details</h2>
  ...
  <div class="section-counter paralax-mf bg-image" style="background-image: url(img/wedding2.jpg)">
 ...
 <section id="about" class="about-mf sect-pt4 route">
  ...
  <section class="paralax-mf footer-paralax bg-image sect-mt4 route" style="background-image: url(img/wedding4.jpg)">
    <div class="overlay-mf"></div>
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>AA Wedding Planner</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
                ...
                -->
                Designed by <a href="#">Amina Ahmed and Ayesha Ali</a>
              </div>
            </div>
          </div>
        </div>
